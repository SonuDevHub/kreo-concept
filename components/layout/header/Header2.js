                            ...
                            <div className="d-lg-flex flex-xl-nowrap flex-wrap align-items-center justify-content-lg-between">
                                <div className="d-flex align-items-center justify-content-between">
                                    <div className="d-flex align-items-center gap-3">
                                        <div className="d-md-none" onClick={handleSidebar}>
                                            <div className="remove-click remove-clickbg-adding d-center">
                                ...
                                <div className="d-lg-flex d-none justify-content-center ph-clickwrap align-items-center gap-xxl-7 gap-xl-6 gap-lg-5 gap-3">
                                    <Link href="tel:+19790567800" className="d-flex align-items-center header-ph gap-2">
