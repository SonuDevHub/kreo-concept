    ...
    return (
        <>
            ...
            <footer className="footer-version-three bg1-clr">
                        ...
                        <div className="row gy-lg-0 gy-10 mt-xxl-5 mb-xxl-5 justify-content-sm-between justify-content-center">
                            ...
                            <div className="col-xxl-3 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div className="footer-widget">
                                    ...
                                    <ul className="link-footer d-grid gap-xxl-5 gap-4" data-aos="zoom-in" data-aos-duration={1600}>
                                        <li className="d-flex align-items-start gap-2 pra-clr">
                                            <i className="fas fa-location-dot theme-clr mt-1" />
                                            Noida, Uttar Pradesh, India
                                        </li>
                                        <li className="d-flex align-items-center gap-2">
                                            <i className="fas fa-envelope theme-clr" />
                                            <Link href="mailto:info.company@gmail.com" className="pra-clr">
                                                info.company@gmail.com
                                            </Link>
                                        </li>
                                        <li className="d-flex align-items-center gap-2">
                                            <i className="fas fa-phone theme-clr" />
                                            <Link href="tel:+19790567800" className="pra-clr">
                                                +197-90-56-780
                                            </Link>
                                        </li>
                                    </ul>
                ...
                <div className="footer-bottom-version-two bg2-clr py-xxl-6 py-xl-5 py-lg-4 py-3">
                    <div className="container">
