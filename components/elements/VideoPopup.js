        ...
        <>
            {style === 1 &&
                ...
                <a onClick={() => setOpen(true)} className="video-popup">
                    ...
                    <img src="/assets/img/stock/about-circle.png" alt="img" className="hero-circle" />
                </a>
            }
            {style === 2 &&
                <a onClick={() => setOpen(true)} className="video-popup step-textcircle">
                    ...
                    <img src="/assets/img/stock/our-process-circle.png" alt="img" className="step-circle" />
                </a>
            }
            {style === 3 &&
                ...
                <img src="/assets/img/stock/our-process-circle.png" alt="img" className="circle" />
            </a>
            }
