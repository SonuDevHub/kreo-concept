...
export default function StepWorking1() {
    return (
        <>
            ...
            <section className="working-sectionv04 pt-space pb-space position-relative">
                <div className="container">
                    <div className="row justify-content-between g-4 mb-xxl-17 mb-xl-12 mb-lg-10 mb-md-10 mb-sm-10 mb-9">
                        ...
                        <div className="col-lg-5">
                            <div className="text-box position-relative">
                                <p>
                                    From the first strategy call to the final launch, we follow a proven process
                                    that keeps every project on track, on brand, and on time.
                                </p>
                                <VideoPopup style={2} />
                            </div>
                        </div>
                            ...
                            <div className="step-working-processitem d-grid gap-7">
                                ...
                                <div className="process-btn">
                                    ...
                                    <svg width={350} height={62} viewBox="0 0 350 62" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <linearGradient id="paint0_linear_6485_42406" x1="1.55534e-07" y1="40.5" x2="316.59" y2="38.8127" gradientUnits="userSpaceOnUse">
                                                <stop offset={2} stopColor="white" />
                                                <stop offset={1} stopOpacity={0} />
                                            </linearGradient>
                                        </defs>
                    ...
                    <div className="step-element1">
                        <img src="/assets/img/stock/our-process-main-image.png" alt="img" />
                    </div>
                    {/* Element */}
                </div>
            </section>
