        ...
        <>
            ...
            <section className="case-study-vsesion01 bg2-clr pb-space">
                <div className="container">
                    ...
                    <div className="text-center mt-xxl-10 mt-xl-8 mt-6">
                        <Link
                            href="/study-grid"
                            className="radius-btn text-capitalize radius100 py-xxl-2 py-2 px-xxl-5 px-5 theme-border theme-clr gap-xxl-4 gap-3 style-2"
                            style={{ display: 'inline-flex', alignItems: 'center', position: 'relative', zIndex: 5 }}
                        >
                            View All Projects
                            <span className="rot60 d-inline-block" style={{ pointerEvents: 'none' }}>
                                <i className="fas fa-arrow-up theme-clr" />
                            </span>
                        </Link>
                    </div>
