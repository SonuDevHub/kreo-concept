                        ...
                        <div className="row g-xxl-7 g-4">
                            <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={2000}>
                                <div className="contact-map">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d112882.5!2d77.3273!3d28.5355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce49041db9df9%3A0x8112502939caa14e!2sNoida%2C%20Uttar%20Pradesh!5e0!3m2!1sen!2sin!4v1711689726724!5m2!1sen!2sin" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
                                </div>
                            </div>
                            <div className="col-lg-6" data-aos="zoom-in" data-aos-duration={2000}>
                                        ...
                                        <div className="row g-xxl-8 g-xl-6 g-lg-4 g-4">
                                            ...
                                            <div className="col-lg-12">
                                                <select className="form-select" defaultValue="">
                                                    ...
                                                    <option value="SEO & Growth Hacking">SEO &amp; Growth Hacking</option>
                                                    <option value="Social Media Alchemy">Social Media Alchemy</option>
                                                    <option value="Creative Brilliance">Creative Brilliance</option>
                                                    <option value="Website Wonders">Website Wonders</option>
                                                    <option value="TVC & Ad Films">TVC &amp; Ad Films</option>
                                                    <option value="Branding & Strategy">Branding &amp; Strategy</option>
                                                    <option value="Lead Generation & Ads">Lead Generation &amp; Ads</option>
                                                    <option value="Ad Copy & Content that Sells">Ad Copy &amp; Content that Sells</option>
                                                </select>
                                            </div>
                                            <div className="col-lg-12">
